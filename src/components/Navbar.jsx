...
export default function Navbar({ onOpenLogin, onOpenSearch, onOpenSheetsConnector, lang, setLang }) {
  ...
  const notifications = [
    { id: 1, title: 'Google Sheets Auto-Sync Ready', time: 'Just now', unread: true },
    { id: 2, title: 'AI Exam Analyzer Updated', time: '10m ago', unread: true },
    { id: 3, title: 'Luly Agency AI Engine v2.4 Active', time: '2h ago', unread: true },
  ];
        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center space-x-1 px-4 py-1.5 rounded-full bg-[#0B1020]/70 border border-white/10 backdrop-blur-md">
            ...
            <a href="#ai-features" className="px-4 py-1.5 rounded-full text-xs font-semibold text-[#00FFC8] hover:bg-[#00FFC8]/10 transition-all flex items-center gap-1">
              ...
              <span>{lang === 'EN' ? 'AI Engine' : 'Fitur AI'}</span>
            </a>
            ...
            <a href="#stats" className="px-4 py-1.5 rounded-full text-xs font-semibold text-slate-300 hover:text-white hover:bg-white/5 transition-all">
              {lang === 'EN' ? 'Analytics' : 'Statistik'}
            </a>
          </nav>
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            {/* Google Sheets Database Connector Trigger */}
            <button
              onClick={onOpenSheetsConnector}
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-[#00FFC8]/10 border border-[#00FFC8]/30 hover:bg-[#00FFC8]/20 text-[#00FFC8] text-xs font-bold transition-all shadow-glow-turquoise"
              title="Google Sheets DB Config"
            >
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden mt-4 p-5 rounded-2xl bg-[#0B1020]/95 border border-[#00D4FF]/30 backdrop-blur-2xl space-y-3 animate-in fade-in slide-in-from-top-4">
            ...
            <button
              ...
              className="w-full text-left py-2 text-sm font-semibold text-[#00FFC8] flex items-center gap-2"
            >
              <FileSpreadsheet className="w-4 h-4" />
